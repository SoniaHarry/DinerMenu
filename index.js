...
function ObtenerPrecio (obj, name){
  /*Recorre un array de objetos en busca del precio de un ingrediente concreto <<name>>
...
*/
    ...
    while (true){
        ...
        else if (opciones.includes(userPlato.trim().toUpperCase()) && userPlato!="") {
    ...
    if (userMenuType != "") {
        ...
        for (let typemenu in aTypeMenu){
          ...
          if (platoseleccionado!="") {
            ...
            let precio=ObtenerPropiedad(aMenuActive, 'precio',aTypeMenu[typemenu],platoseleccionado.trim())[0];
        ...
        //Los arrays que contienen lo que ha pedido el usuario y sus precios
